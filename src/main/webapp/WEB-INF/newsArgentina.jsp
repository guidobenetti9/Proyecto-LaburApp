...
<body>
    <div class="content">
        ...
        <div class="uk-card-2 uk-card-default ">
      	...
      	<h3 class="uk-text-center" >Cotizaciones del Dolar</h3>
    
        <div class="filter-container">  
        <c:forEach items="${dolares}" var="dolar">   
        	<button class="uk-button uk-button-default" type="button">${dolar.nombre}</button>
        ...
        <div class="button-container">
            <div class="uk-card-2 uk-card-default">
                <h3>Ultimas Noticias Argentina</h3>
                <div class="service-card">
				    <c:forEach items="${news.articles}" var="newArticle">
				        <div class="uk-card uk-card-default uk-card-hover">
				            <div class="uk-card-body">
				    			<h3 class="uk-card-title uk-margin-remove-top">${newArticle.title}</h3>
				            	<p>${newArticle.author}</p>
				                <h3 class="uk-card-title"><a href="${newArticle.url}">Ver Noticia</a></h3>
				                <div class="uk-flex uk-flex-between">
				                    <div class="service-description">
				                        <p class="uk-text-meta"><time datetime="${newArticle.publishedAt}">${newArticle.publishedAt}</time></p>                                                                            
				                    </div>
				                </div>
				            </div>
				        </div>
