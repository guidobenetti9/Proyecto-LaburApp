				    ...
				    <c:forEach items="${users}" var="user">
				        <div class="uk-card uk-card-default uk-card-hover">
				            <div class="uk-card-body">
				                <h3 class="uk-card-title"><a href="/userProfile/${user.id}">${user.firstName} ${user.lastName}</a></h3>
				                <div class="uk-flex uk-flex-between">
				                    <div class="service-description">
				                        <p class="description-text">@${user.username}</p>
				                        <p class="uk-text-meta"><time datetime="${user.createdAt}">Miembro desde: ${user.createdAt}</time></p>
				                        <p class="uk-text-meta">Ubicación: ${user.province} ${user.city}</p>                                     
